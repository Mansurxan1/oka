...
const CategoryAll = () => {
  ...
  const [isExiting, setIsExiting] = useState(false); // ✨ Animatsiya nazorati
  ...
  return (
    <div
      className={`max-w-[450px] mt-10 mx-auto mb-40 transition-all duration-500 ${
    ...
    >
      <div className="flex items-center text-center gap-3 mb-4 rounded-bl-[20px] rounded-br-[20px] border-b-[2px] border-b-[#00000050] px-3 pb-4">
        <button
          onClick={handleClose} // 🔥 Tugmaga animatsiyali chiqib ketish funksiyasini bog'lash
